...
urlpatterns = [
    ...
    #QuentionPoll
    path('listado/pregunta/encuesta/', login_required(QuestionPollLIst.as_view()), name='question_poll_list'),
    ...
    #QuestionInterview
    path('listado/pregunta/entrevista/', login_required(QuestionInterviewLIst.as_view()), name='question_interview_list'),
